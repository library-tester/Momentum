...
const COMMANDS = [
  ...
  { usage: 'start <id|all>', desc: 'mark task(s) active' },
  { usage: 'stop <id|all>', desc: 'put active task(s) back to pending' },
  { usage: 'done <id|all>', desc: 'complete task(s) — moves them to the archive' },
  { usage: 'rm <id|all>', desc: 'delete task(s)  (also: remove, delete)' },
  { usage: 'undo', desc: 'undo the last command that changed anything' },
  { usage: 'priority <id|all> <high|med|low>', desc: 'change priority', feat: 'priority' },
  ...
  { usage: 'due <id|all> <date|none>', desc: 'set or clear a due date', feat: 'due',
    extra: () => ['takes today, tomorrow, friday, +3d, eom, none …  ("help dates" for the full list)'] },
  { usage: 'est <id|all> <time|none>', desc: 'set or clear how long you think it\'ll take', feat: 'est',
    extra: () => ['takes 45m, 2h, 1h30, 1.5h, 90 (bare = minutes), 2d (a day is 8h), none',
                  '("-dur", "-duration" and "-time" work as flag spellings too)']},
  { usage: 'tag <id|all> add <tag>', desc: 'add a tag to task(s)', feat: 'tags' },
  { usage: 'tag <id|all> rm <tag>', desc: 'remove a tag from task(s)', feat: 'tags' },
  { usage: 'tag <id|all> set <tag1,tag2,...>', desc: "replace all of task(s)' tags", feat: 'tags' },
  { usage: 'tags', desc: 'list every tag in use', feat: 'tags' },
  { usage: 'mark <id|all> [off]', desc: 'put the • mark in the margin  (bare form marks, "off" clears)', feat: 'tags',
  ...
  { usage: 'archive rm <id|all>', desc: 'permanently delete archived task(s) — no coming back from this one' },
  { usage: 'restore <id|all>', desc: 'move archived task(s) back to your list' },
  ...
  { usage: 'gallery rm <n|name|all>', desc: 'remove piece(s) from your collection  (also: remove, delete)',
